...
import co.askseoulites.seoulcityapp.ColorUtils;
...
import co.askseoulites.seoulcityapp.helper.IntProperty;
...
public abstract class AbsQuizView<Q extends Quiz> extends FrameLayout {
    ...
    private void setUpQuestionView() {
        ...
        mQuestionView.setBackgroundColor(ContextCompat.getColor(getContext(),
                ColorUtils.getMaterialPrimary(0)));
        //TODO : Question Title
        mQuestionView.setText("question title");
    }
            ...
            public void run() {
              /*  mCategory.setScore(getQuiz(), answerCorrect);*/
                if (getContext() instanceof QuestionDetailActivity) {
                   /* ((QuestionDetailActivity) getContext()).proceed();*/
                }
            }
        };
