...
import co.askseoulites.seoulcityapp.model.FillBlankQuiz;
...
public class FillBlankQuizView extends TextInputQuizView<FillBlankQuiz> {
    ...
    public FillBlankQuizView(Context context) {
        super(context);
    }
...
//        String end = getQuiz().getEnd();
    ...
    private View getStartEndView(String start, String end) {
        ...
        mAnswerView = (EditText) container.findViewById(R.id.answer_edit_text);
